...
$(function() {
  var bookmark = {
    data: [{
      name: '往前方',
      link: 'http://www.qianfangzy.com/',
      icon: 'img/log.png',
    }, {
      name: '优惠券',
      link: 'http://mai.qnfuli.com/',
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "听松阁 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "听松阁 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "听松阁 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "听松阁 | Stay up late again";
}
//title问候语结束
